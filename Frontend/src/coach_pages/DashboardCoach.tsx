  ...
  useEffect(() => {
    ...
    async function cargarDatos(idValidado: number) {
      try {
        ...
        setRutinasTotales(
          rutinas.filter(r => r.id_coach === idValidado).length
        );
        ...
        console.error(
          "Error al cargar los datos del procedimiento o endpoints secundarios:",
          err
        );
      } finally {
        setLoading(false);
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400">
            Control de entrenamientos y antropometría.
          </p>
        </div>
                ...
                >
                  ...
                  <td className="p-4">
                    <div className="flex justify-center gap-3">
                      <button
                        onClick={() =>
                          navigate(`/coach/cliente/${c.id_usuario}/medidas`)
                        }
                      ...
                      <button
                        onClick={() =>
                          navigate(`/coach/cliente/${c.id_usuario}/asignar`)
                        }
